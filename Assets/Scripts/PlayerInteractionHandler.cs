...
public class PlayerInteractionHandler : MonoBehaviour
{
    ...
    public void SetInteractable(IInteractable newInteractable)
    {
        ...
        Debug.Log("New Interactable set on instance: " + GetInstanceID() + " | Is null: " + (_currentInteractable == null));
    }
    ...
    public void ClearInteractable(IInteractable requestingInteractable)
    {
        ...
        if (_currentInteractable == requestingInteractable){
    ...
    public void Interact(InputAction.CallbackContext context)
    {
        ...
        Debug.Log("Interact called on instance: " + GetInstanceID());
